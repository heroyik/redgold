...
const UI_COPY: Record<AppLanguage, UiCopy> = {
  en: {
    ...
    playAlt: 'Play',
    landingHero: `HSK 4 prep, but make it vibe. <strong>Red</strong> is the textbook stuff you need to know. <strong>Gold</strong> is the real-world talk people actually use. <strong>RedGold</strong> brings it all together for the ultimate HSK 4 experience. For focused vocabulary practice, use <a href="https://heroyik.github.io/qingvoca/" target="_blank" rel="noopener noreferrer">qingvoca</a>, this app's companion vocab study app. No robots allowed.`,
    learned: 'Learned',
    done: 'Well Done!',
  ...
  ko: {
    ...
    audioTooltip: '발음 듣기',
    playAlt: '재생',
    landingHero: `HSK 4급, 이제 '진짜'로 배워보자고. <strong>Red</strong>는 우리가 꼭 알아야 할 교과서 정석. <strong>Gold</strong>는 현지인들이 입에 달고 사는 찐 생활 중국어. 이 둘이 만나 <strong>RedGold</strong>가 됐어. 단어 집중 학습은 이 앱의 단어장 학습앱 <a href="https://heroyik.github.io/qingvoca/" target="_blank" rel="noopener noreferrer">qingvoca</a>에서 이어서 해봐. 뻔한 공부 말고 진짜 실력을 키워봐.`,
    learned: '학습 완료',
    done: '참 잘했어요!',
  ...
  ja: {
    ...
    playAlt: '再生',
    landingHero: `HSK 4級、もっとエモく学ぼう。<strong>Red</strong>は基本の教科書モード。<strong>Gold</strong>はネイティブがガチで使うリアルな言い回し。この二つが合体して <strong>RedGold</strong>。単語を集中して覚えるなら、このアプリの単語帳学習アプリ <a href="https://heroyik.github.io/qingvoca/" target="_blank" rel="noopener noreferrer">qingvoca</a> も使ってみて。ロボットみたいな中国語はもう卒業しない？`,
    learned: '学習済み',
    done: 'お疲れ様でした！',
    sub: 'このセッションを完了しました。',
    restart: '再開する',
