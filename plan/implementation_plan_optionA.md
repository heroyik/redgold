...
- [x] Create `VocabCard` compact mode (single face)
- [x] Integrate compact cards into VOCAB tab grid
- [x] Optimize card height to 160px for high-density scanning
- [x] Preserve flip animation for REVIEW tab
